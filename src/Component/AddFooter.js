                ...
                <div className='rowFooter'>
                    ...
                    <div className='div3Col'>
                        ...
                        <div className="FollowUs">For More Details Follow us :
                            ...
                            <img className='circleFollow' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSGs1LETqnEyuX9xvRmPjHK7ulEtLeXSpYLHQ&usqp=CAU"></img>
                            <img  className="circleFollow" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS7zTyVz8gyeFBXNFNC_TJ2mdKZXMUiY6LoFg&usqp=CAU"></img>
                        </div>
